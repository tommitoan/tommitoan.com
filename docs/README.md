...
- `features.md` route-level and platform-level feature inventory
- `implementation.md` actual code structure and ownership
- `configuration.md` app-level configuration reference
